...
const messages = {
  tr: {
    ...
    auth: {
      ...
      forgotPasswordSubtitle: "Email adresinizi girin, size şifre sıfırlama linki gönderelim.",
      forgotPasswordFunnyMessage: "Noel Baba bile şifresini unutuyor! 🎅",
      sendResetLink: "Sıfırlama Linki Gönder",
      forgotPasswordSuccess: "Şifre sıfırlama linki email adresinize gönderildi.",
      backToLogin: "Giriş sayfasına dön",
      resetPasswordTitle: "Şifre Sıfırlama",
      resetPasswordSubtitle: "Yeni şifrenizi belirleyin.",
      resetPasswordFunnyMessage: "Not almayı unutmayın:)",
      ...
      resetPasswordSuccess: "Şifreniz başarıyla sıfırlandı. Giriş sayfasına yönlendiriliyorsunuz...",
    },
  },
  en: {
    languageSwitcher: {
    ...
    auth: {
      ...
      forgotPasswordFunnyMessage: "Even Santa forgets his password! 🎅",
      ...
      resetPasswordFunnyMessage: "Don't forget to write it down:)",
      newPasswordLabel: "New Password",
      newPasswordPlaceholder: "Enter your new password",
      confirmPasswordLabel: "Confirm Password",
      confirmPasswordPlaceholder: "Confirm your new password",
      resetPasswordButton: "Reset Password",
      resetPasswordSuccess: "Your password has been reset successfully. Redirecting to login...",
    },
  },
} as const;
